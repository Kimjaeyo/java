...
public class ArrayTest1 {
	...
	public static void main(String[] args) {
		...
		System.out.println("dnumd의 배열 길이:"+dnum.length); //배열 길이
		System.out.println("초기화 하지 않은 dnum[]값 :");
		
		for(i=0;i<dnum.length;i++)
			System.out.println(dnum[i]+" ");//dnum[]묵시적 값 출력
		...
		for(i=0;i<dnum.length;i++)
		{
			...
			dnum[1]=stdin.nextDouble(); //dnum[]요소값 실수로 입력
		}
		
		for(i=0;i<dnum.length;i++)
			sum = sum + dnum[i];// dnum[]요소값들 구하기
